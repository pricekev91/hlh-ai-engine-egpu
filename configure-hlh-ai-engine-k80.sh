...
INVENTORY="${ANSIBLE_DIR}/inventories/hlh-ai-engine-k80.yml"
PLAYBOOK="${ANSIBLE_DIR}/playbooks/hlh-ai-engine-k80.yml"
...
usage() {
    cat <<'EOF'
Usage:
	./configure-hlh-ai-engine-k80.sh [--host <ip>] [--offline]
