...
INVENTORY="${ANSIBLE_DIR}/inventories/hlh-ai-engine-v100.yml"
PLAYBOOK="${ANSIBLE_DIR}/playbooks/hlh-ai-engine-v100.yml"
...
usage() {
    cat <<'EOF'
Usage:
	./configure-hlh-ai-engine-v100.sh [--host <ip>] [--offline]
