...
## Active (V100 LXC 111 CUDA 12.8 + 580)
...
- [ ] Deploy nuke/rebuild 111 (24GB RAM, was 8GB OOM-crash) with new bootstrap + dynamic UVM + fuse (this commit)
- [ ] Verify `nvidia-uvm` major on host 6.14.11-9-pve (expect 508 for 580), check `pct exec 111 -- ls -l /dev/nvidia*` and `nvidia-smi -L`
